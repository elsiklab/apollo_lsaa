...
function(
    ...
    return declare(ActionBarDialog, {
        ...
        show: function() {
            ...
            this.set('content', [
                dom.create('p', { innerHTML: 'Provide coordinate of an inversion or flipped scaffold which will be reverse complemented. See the <a href="http://genomes.missouri.edu/help.html">Help Guide</a> for additional information.' }), br(),
